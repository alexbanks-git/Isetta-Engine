...
void FrameReporter::GuiUpdate() {
  ...
  GUI::Window(RectTransform{Math::Rect{20, 10, 150, 80}}, "Frame Reporter",[&]() {
                ...
                GUI::Text(RectTransform{Math::Rect{5, 5, 50, 5}}, Util::StrFormat("FPS: %.0f", fps));


                GUI::Text(RectTransform{Math::Rect{5, 15, 50, 5}},Util::StrFormat("Time: %.1f ms", frameTime));
                ...
                GUI::Text(RectTransform{Math::Rect{5, 25, 50, 5}},Util::StrFormat("Avg: %.1f ms", timeSumForAvg * 1000 /frameCountForAvg));
                //std::cout << "frameReporter" << std::endl;
              },
              &isOpen);
}
