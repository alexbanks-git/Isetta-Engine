...
class  GUI {
 public:
  ...
  struct  ImageStyle {
    ...
    int framePadding = -1;
    ImageStyle() = default;
   /* ImageStyle(const Color& tint, const Color& frame, int framePadding): tint(tint), frame(frame), framePadding(framePadding) {}
    ImageStyle(const Math::Vector2& offset, const Math::Vector2& tiling): offset(offset), tiling(tiling) {}
    ImageStyle(const Color& tint, const Color& frame, int framePadding, const Math::Vector2& offset, const Math::Vector2& tiling)
        : tint(tint),
          frame(frame),
  ...
  struct  TextStyle {
    ...
    Color text;
    TextStyle();
    TextStyle(const Color& text): text{text}, isWrapped{false}, isDisabled{false} {}
    TextStyle(float fontSize, const std::string_view& fontName = "");
    TextStyle(class Font* const font);
    TextStyle(const Color& text, float fontSize,const std::string_view& fontName = "");
    TextStyle(const Color& text, class Font* const font): text{text}, font{font} {}
  ...
  // BUTTONS
  static bool Button(const RectTransform& transform,
  ...
  */
  ...
  static void Toggle(const RectTransform& transform,
		             const std::string& label,
  ...
  */
  ...
  // TEXT
  static void Text(const RectTransform& transform,const std::string_view format);
  ////////////////////////////////////////
  // TODO(Jacob) NOT PART OF GAME NEEDS //
  ////////////////////////////////////////
  /*
...
//						   const InputStyle& style = {},
  ...
  */
  ...
  // WINDOWS
  static bool Window(const RectTransform& transform, const std::string& name,const Action<>& ui, bool* isOpen = NULL,const WindowFlags flags = WindowFlags::None);
  static void Child(const RectTransform& transform, const std::string& id,const Action<>& ui, bool border = false,WindowFlags flags = WindowFlags::None);
  static bool MenuBar(const Action<>& ui, bool main = false);
  static bool Menu(const std::string& label, const Action<>& ui,bool enabled = true);
  static bool MenuItem(const std::string& label, const std::string& shortcut,bool selected = false, bool enabled = true);
  static void MenuItem(const std::string& label, const std::string& shortcut,const Action<>& callback, bool enabled = true);
  static bool Modal(const RectTransform& transform, const std::string& name,const Action<>& ui, bool* isOpen = NULL,const ModalStyle& style = {},WindowFlags flags = WindowFlags::None);
  ...
  */
  struct  Draw {
    static void Rect(const RectTransform& transform, const Color& color,const float roundCorners = 0.0f,DrawCornerFlags flags = DrawCornerFlags::All,float thickness = 1.0f);
    static void RectFilled(const RectTransform& transform, const Color& color, const float roundCorners = 0.0f,DrawCornerFlags flags = DrawCornerFlags::All);
    static void Quad(const RectTransform& transform, const Math::Vector2&,const Math::Vector2&, const Math::Vector2&,const Math::Vector2&, const Color& color,float thickness = 1.0f);
    static void QuadFilled(const RectTransform& transform, const Math::Vector2&,const Math::Vector2&, const Math::Vector2&,const Math::Vector2&, const Color& color);
    static void Triangle(const RectTransform& transform, const Math::Vector2&,const Math::Vector2&, const Math::Vector2&,const Color& color, float thickness = 1.0f);
    static void TriangleFilled(const RectTransform& transform,const Math::Vector2&, const Math::Vector2&,const Math::Vector2&, const Color& color);
    static void Circle(const RectTransform& transform, float radius,const Color& color, int segments = 12,float thickness = 1.0f);
    static void CircleFilled(const RectTransform& transform, float radius,const Color& color, int segments = 12);
 ...
 private:
  ...
  static bool Button(Func<bool> button, const RectTransform& transform, bool repeating);
